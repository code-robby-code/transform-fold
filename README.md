...
* A variety of fold/unfold transition effects for a foldable phone.
* The effect is rendered independently of the launcher and sits over whatever is currently being displayed, so you can use it with any launcher/app.
* It renders everything live, and it does not take screenshots of your screen to create the animation.
...
* Parallax Curtain - Curtain effect that stretches
* Spring Door - Spring loaded door effect
